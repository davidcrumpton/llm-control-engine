...
```bash
llmctrlx.ts chat -u 'Tell me what tools the agent presents to you' -m gemma4:e2b --tags os
```
...
```bash
llmctrlx.ts chat -u 'Tell me what tools the agent presents to you' -m gemma4:e2b --tags web
```
...
```bash
llmctrlx.ts chat -u 'What can you do?' -m gemma4:e2b --tags web
```
